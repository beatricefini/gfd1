document.addEventListener("DOMContentLoaded", () => {
  ...
  function handleSequences() {
    ...
    // --- Step 0: piece1 & piece2 + image text1 ---
    if (sequenceStep === 0) {
      ...
      img.setAttribute("animation__fadein", { property: "opacity", from: 0, to: 1, dur: 800, easing: "easeInQuad" });
      introContainer.appendChild(img);

      sequenceStep = 1;

    // --- Step 1: piece3, piece4, piece5 ---
    ...
    // --- Step 2: piece6 + finale 1958 & Ruins + cinema ---
      ...
      text1958.setAttribute("position", "0 0.5 0.5");
      ...
      textRuins.setAttribute("position", "0 0.4 0.5");
      ...
      // Dopo fadein, aggiungiamo modello cinema
      setTimeout(() => {
