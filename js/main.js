document.addEventListener("DOMContentLoaded", () => {
  ...
  marker.addEventListener("targetFound", () => {
    ...
    introImg.setAttribute("scale", "0.8 0.8 0.8");
    introImg.setAttribute("id", "introImage");
  ...
  function handleSequences() {
    ...
    if (sequenceStep === 0) {
      ...
      img1.setAttribute("position", "0 -0.2 0");
      img1.setAttribute("scale", "0.8 0.8 0.8");
      ...
      img2.setAttribute("position", "0 -0.2 0");
      img2.setAttribute("scale", "0.8 0.8 0.8");
      ...
      [2,3,4].forEach((i, idx) => {
        const posArr = ["-0.05 0.2 0.35","0.05 0.45 0.35","0.15 0.3 0.35"];
        frameEntities[i].setAttribute("animation__pos_zoom", { property: "position", to: posArr[idx], dur:800, easing:"easeInOutQuad" });
      ...
      resetAllModels([5], () => { sequenceStep = 7; });
      ...
      setTimeout(() => {
        ...
        // mostro il modello cinema dopo i testi
        setTimeout(showFinalCinema,2000);
      },600);
